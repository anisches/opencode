            ...
            setStore(
              produce((draft) => {
                ...
                for (const message of currentMessages) {
                  if (optimisticMessages.has(message.id) && !infos.some((item) => item.id === message.id)) {
                ...
                for (const message of messages.data ?? []) {
                  ...
                  if (message.parts.length === 0 && optimisticMessages.has(message.info.id)) {
                  ...
                  if (parts.length > 0) optimisticMessages.delete(message.info.id)
